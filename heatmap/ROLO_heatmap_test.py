...
'''
Script File: ROLO_heatmap_test.py
    ...
    def test_heat_all(self):
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(epoches):
                ...
                self.output_path = os.path.join('benchmark/DATA', sequence_name, 'rolo_heat_test/')
                ...
                while id  < self.testing_iters- self.num_steps:
                    # Load training data & ground truth
                    batch_xs = utils.load_yolo_output_heatmap(None, x_path, self.batch_size, self.num_steps, id) # [num_of_examples, num_input] (depth == 1)
